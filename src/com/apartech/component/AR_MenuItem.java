...
public class AR_MenuItem extends javax.swing.JPanel {

    public AR_ModelMenu getMenu() {
        return menu;
    }
    ...
    public AR_EventMenuSelected getEventSelected() {
        return eventSelected;
    }

    public void setEventSelected(AR_EventMenuSelected eventSelected) {
    ...
    private float alpha;
    private AR_ModelMenu menu;
    private boolean open;
    private AR_EventMenuSelected eventSelected;
    private int index;

    public AR_MenuItem(AR_ModelMenu menu, AR_EventMenu event, AR_EventMenuSelected eventSelected, int index) {
        initComponents();
        this.menu = menu;
        this.eventSelected = eventSelected;
        this.index = index;
        ...
        AR_MenuButton firstItem = new AR_MenuButton(menu.getIcon(), "      " + menu.getMenuName());
        firstItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                if (menu.getSubMenu().length > 0) {
                    if (event.menuPressed(AR_MenuItem.this, !open)) {
                        open = !open;
                    }
                }
        ...
        for (String st : menu.getSubMenu()) {
            AR_MenuButton item = new AR_MenuButton(st);
