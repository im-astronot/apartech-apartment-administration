...
public class M_MenuItem extends javax.swing.JPanel {

    public M_ModelMenu getMenu() {
        return menu;
    }
    ...
    public M_EventMenuSelected getEventSelected() {
        return eventSelected;
    }

    public void setEventSelected(M_EventMenuSelected eventSelected) {
    ...
    private float alpha;
    private M_ModelMenu menu;
    private boolean open;
    private M_EventMenuSelected eventSelected;
    private int index;

    public M_MenuItem(M_ModelMenu menu, M_EventMenu event, M_EventMenuSelected eventSelected, int index) {
        initComponents();
        this.menu = menu;
        this.eventSelected = eventSelected;
        this.index = index;
        ...
        M_MenuButton firstItem = new M_MenuButton(menu.getIcon(), "      " + menu.getMenuName());
        firstItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                if (menu.getSubMenu().length > 0) {
                    if (event.menuPressed(M_MenuItem.this, !open)) {
                        open = !open;
                    }
                }
        ...
        for (String st : menu.getSubMenu()) {
            M_MenuButton item = new M_MenuButton(st);
