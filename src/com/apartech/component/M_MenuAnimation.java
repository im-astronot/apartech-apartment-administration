...
public class M_MenuAnimation {

    private final MigLayout layout;
    private final M_MenuItem menuItem;
    private Animator animator;
    private boolean open;

    public M_MenuAnimation(MigLayout layout, Component component) {
        this.layout = layout;
        this.menuItem = (M_MenuItem) component;
        initAnimator(component, 200);
    }

    public M_MenuAnimation(MigLayout layout, Component component, int duration) {
        this.layout = layout;
        this.menuItem = (M_MenuItem) component;
