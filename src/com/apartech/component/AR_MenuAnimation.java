...
public class AR_MenuAnimation {

    private final MigLayout layout;
    private final AR_MenuItem menuItem;
    private Animator animator;
    private boolean open;

    public AR_MenuAnimation(MigLayout layout, Component component) {
        this.layout = layout;
        this.menuItem = (AR_MenuItem) component;
        initAnimator(component, 200);
    }

    public AR_MenuAnimation(MigLayout layout, Component component, int duration) {
        this.layout = layout;
        this.menuItem = (AR_MenuItem) component;
